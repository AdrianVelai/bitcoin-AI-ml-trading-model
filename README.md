...
Trades run on a **simulated account with real spreads, swaps and commissions** (Afterprime), and are posted to [Telegram](https://t.me/bitcoinaiproo) at the moment of execution — timestamps precede outcomes. The account is read independently by [FXBlue](https://www.fxblue.com/users/bitcoinaipro).
...
Full details of the graveyard, including the discarded feature list, are on the [methodology page](https://www.bitcoinai.pro/ai-trading-models/).
